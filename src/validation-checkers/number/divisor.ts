...
): ValidationCheckerFunction<number> =>
  checkIf(
...
export const checkNumberIsInteger = (validationError: ValidationError = defaultValidationError): ValidationCheckerFunction<number> =>
